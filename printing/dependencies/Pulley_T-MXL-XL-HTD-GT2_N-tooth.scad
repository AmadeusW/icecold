...
pulley_t_ht = 13.5;	// length of toothed part of pulley, standard = 12
pulley_b_ht = 7.0;		// pulley base height, standard = 8. Set to same as idler_ht if you want an idler but no pulley.
pulley_b_dia = 8.0;	// pulley base diameter, standard = 20
